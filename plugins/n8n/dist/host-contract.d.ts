...
export type IntegrationConnectResult = IntegrationAuthorizationUrlConnectResult | IntegrationConnectedConnectResult;
...
export interface IntegrationProvider {
    ...
    connect?(capabilities: ReadonlyArray<string>, context?: IntegrationLifecycleContext, submission?: IntegrationConnectionSubmission): Promise<IntegrationConnectResult>;
