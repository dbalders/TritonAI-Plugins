...
before interpreting document field keys. Use bounded pagination for document lists and request one
document only when its exact ID is known. User lookup is a bounded search, not an identity proof.
