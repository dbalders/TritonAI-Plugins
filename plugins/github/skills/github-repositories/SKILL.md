...
1. Use `github.identity.get` when account context matters. Use `github.repositories.list` to enumerate a bounded page of repositories available to the signed-in OAuth user; there is no GitHub App installation or repository picker.
