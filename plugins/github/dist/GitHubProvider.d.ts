...
export declare const GITHUB_SECRET_SUFFIX = "github-app-user";
export interface GitHubConfiguration {
    readonly clientId: string;
}
export declare const GITHUB_TOOLS: readonly [IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool, IntegrationProviderTool];
